      ...
      <div className="col-span-4 overflow-auto scrollbar h-[300px]">
        ...
        {cartItems.map((item) => (
          ...
          >
            ...
            <div className="mr-1">
              <button
                className="mr-2 text-xl bg-blue-300 p-2 pt-0 pb-0 rounded-md"
                onClick={() => onAdd(item)}
              >
                +
              </button>
              <button
                className="mr-2 text-xl bg-red-300 p-3 pt-0 pb-0 rounded-md"
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="col-span-4">
            <div className="grid grid-cols-3 gap-x-1 h-auto">
              ...
              <div className="col-span-1 flex flex-col">
                <span className="bg-green-600 h-[72px] text-center pt-6 cursor-pointer">
                  Payment
                </span>
              </div>
            </div>
