...
const Navbar = () => {
  ...
  return (
    <div className="flex h-14 bg-[#35589A] items-center justify-between font-bold text-slate-300">
      ...
      <div onClick={toggleHandler} className="mr-6 flex justify-between relative items-center bg-blue-500 p-1 pr-2 pl-2 rounded cursor-pointer">
        <FaUserCircle size={22} className="mr-2" />
        <h3 className="text-sm">Admin</h3>
        {isToggle &&
          <div className="bg-slate-400 absolute h-96 w-80 top-9 right-0 rounded">
            <h2>Hello</h2>
          </div>
        }
      </div>
